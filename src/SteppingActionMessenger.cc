...
(aSteppingAction* SA):steppingAction(SA) {

  colourNeutronCmd = new G4UIcmdWithAString("/Ana/draw/neutronColour",this);
  ...
  colourGammaCmd = new G4UIcmdWithAString("/Ana/draw/gammaColour",this);
  ...
  colourOpticalCmd = new G4UIcmdWithAString("/Ana/draw/opticalColour",this);
  ...
  colourChargedPlusCmd = new G4UIcmdWithAString("/Ana/draw/chargedplusColour",this);
  ...
  colourChargedMinusCmd = new G4UIcmdWithAString("/Ana/draw/chargedminusColour",this);
